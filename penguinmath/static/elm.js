...
var author$project$PenguinMath$baseUrl = '/penguinmath/api/';
...
var author$project$PenguinMath$initialModel = function () {
	var emptyQuiz = {
		answers: elm$core$Array$fromList(_List_Nil),
		goal: 0,
		name: '',
		questions: elm$core$Array$fromList(_List_Nil),
		title: '',
		total: 0
	};
	return {answer: '', count: 0, lastWrong: false, myAnswer: '', page: author$project$PenguinMath$Intro, question: '', quiz: emptyQuiz, quizHeaders: _List_Nil, right: 0, wrong: 0};
}();
...
var author$project$PenguinMath$getAnswer = function (model) {
	var _n0 = A2(elm$core$Array$get, model.count, model.quiz.answers);
	if (_n0.$ === 'Just') {
		var a = _n0.a;
		return a;
	} else {
...
var author$project$PenguinMath$getQuestion = function (model) {
	var _n0 = A2(elm$core$Array$get, model.count, model.quiz.questions);
	if (_n0.$ === 'Just') {
		var q = _n0.a;
		return q;
	} else {
...
var author$project$PenguinMath$getNextPage = function (model) {
	return (_Utils_cmp(model.count, model.quiz.total) < 0) ? _Utils_update(
		model,
		{
			answer: author$project$PenguinMath$getAnswer(model),
			myAnswer: '',
			page: author$project$PenguinMath$AskQuestion,
			question: author$project$PenguinMath$getQuestion(model)
		}) : ((_Utils_cmp(model.right, model.quiz.goal) > -1) ? _Utils_update(
		model,
		{page: author$project$PenguinMath$HappyPengi}) : _Utils_update(
		model,
		{page: author$project$PenguinMath$SadPengi}));
};
var author$project$PenguinMath$RightAnswer = {$: 'RightAnswer'};
var author$project$PenguinMath$WrongAnswer = {$: 'WrongAnswer'};
var author$project$PenguinMath$WrongTwice = {$: 'WrongTwice'};
var elm$core$String$trim = _String_trim;
var author$project$PenguinMath$rightOrWrong = function (model) {
	return _Utils_eq(
		elm$core$String$trim(model.myAnswer),
		model.answer) ? (model.lastWrong ? _Utils_update(
		model,
		{count: model.count + 1, lastWrong: false, page: author$project$PenguinMath$RightAnswer}) : _Utils_update(
		model,
		{count: model.count + 1, lastWrong: false, page: author$project$PenguinMath$RightAnswer, right: model.right + 1})) : (model.lastWrong ? _Utils_update(
		model,
		{count: model.count + 1, lastWrong: false, page: author$project$PenguinMath$WrongTwice}) : _Utils_update(
		model,
...
var author$project$PenguinMath$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Enter':
				return _Utils_Tuple2(
					author$project$PenguinMath$rightOrWrong(model),
					elm$core$Platform$Cmd$none);
			case 'Next':
				return _Utils_Tuple2(
					author$project$PenguinMath$getNextPage(model),
					elm$core$Platform$Cmd$none);
			case 'StartOver':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{answer: '', count: 0, lastWrong: false, myAnswer: '', page: author$project$PenguinMath$Intro, question: '', right: 0, wrong: 0}),
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								answer: author$project$PenguinMath$getAnswer(
									_Utils_update(
										model,
										{quiz: quiz})),
								question: author$project$PenguinMath$getQuestion(
									_Utils_update(
										model,
										{quiz: quiz})),
								quiz: quiz
	...
	switch (_n0.$) {
		case 'Intro':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('select quiz')
					]),
				_List_fromArray(
					[
						A2(
		...
		case 'AskQuestion':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$value(model.myAnswer),
						elm$html$Html$Events$onInput(author$project$PenguinMath$Input),
						elm_community$html_extra$Html$Events$Extra$onEnter(author$project$PenguinMath$Enter)
					]),
				_List_Nil);
		case 'RightAnswer':
			return A2(
		...
		case 'SadPengi':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$PenguinMath$StartOver)
					]),
				_List_fromArray(
					[
...
var author$project$PenguinMath$displayCaption = function (model) {
	var score = elm$core$String$fromInt(model.right) + (' out of ' + elm$core$String$fromInt(model.quiz.total));
	var _n0 = model.page;
	switch (_n0.$) {
		case 'Intro':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Hi, I\'m Pengi the Penguin. Let\'s choose a quiz.')
					]));
		case 'AskQuestion':
			return A2(
				elm$html$Html$p,
		...
		case 'WrongTwice':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Double oops. The right answer  is ' + (model.answer + '.'))
					]));
		case 'SadPengi':
			return A2(
				elm$html$Html$p,
				...
				_List_fromArray(
					[
						elm$html$Html$text('You answered ' + (score + ' correctly. Pengi is a bit sad.'))
					]));
		default:
			return A2(
				elm$html$Html$p,
				...
				_List_fromArray(
					[
						elm$html$Html$text('Yay! You answered ' + (score + ' correctly! Pengi is very happy!'))
					]));
	}
};
...
var author$project$PenguinMath$displayHeader = function (model) {
	return _Utils_eq(model.page, author$project$PenguinMath$Intro) ? A2(
		...
		_List_fromArray(
			...
			])) : (_Utils_eq(model.page, author$project$PenguinMath$WrongTwice) ? A2(
		elm$html$Html$h2,
		_List_fromArray(
			[
...
var author$project$PenguinMath$displayPengi = function (model) {
	var pengiVid = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$src('/static/resources/pengi.mov'),
	...
	var pengiImg = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$src('/static/resources/pengi.png'),
	...
	var deadImg = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$src('/static/resources/dead penguin.png'),
				elm$html$Html$Attributes$height(130)
			]),
		_List_Nil);
	return _Utils_eq(model.page, author$project$PenguinMath$HappyPengi) ? pengiVid : (_Utils_eq(model.page, author$project$PenguinMath$SadPengi) ? deadImg : pengiImg);
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Right: ' + elm$core$String$fromInt(model.right))
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Questions left: ' + elm$core$String$fromInt((model.quiz.total - model.right) - model.wrong))
					]))
			]));
};
...
var author$project$PenguinMath$main = elm$browser$Browser$element(
	{init: author$project$PenguinMath$init, subscriptions: author$project$PenguinMath$subscriptions, update: author$project$PenguinMath$update, view: author$project$PenguinMath$view});
_Platform_export({'PenguinMath':{'init':author$project$PenguinMath$main(
