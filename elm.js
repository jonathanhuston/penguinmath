...
{
	if (region.af.P === region.ak.P)
	{
		return 'on line ' + region.af.P;
	}
	return 'on lines ' + region.af.P + ' through ' + region.ak.P;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.k, request.aH, true);
		} catch (e) {
...
var author$project$PenguinMath$baseUrl = 'https://penguinmath.herokuapp.com/penguinmath/api/';
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{F: false, aL: r.aL, am: r.am, g: r.g, k: r.k, l: r.l, m: r.m, aH: r.aH}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{aL: elm$http$Http$emptyBody, am: r.am, g: _List_Nil, k: 'GET', l: elm$core$Maybe$Nothing, m: elm$core$Maybe$Nothing, aH: r.aH});
};
var author$project$PenguinMath$fetchQuizHeaders = elm$http$Http$get(
	{
		am: A2(elm$http$Http$expectJson, author$project$PenguinMath$LoadQuizHeaders, author$project$PenguinMath$headersDecoder),
		aH: author$project$PenguinMath$baseUrl + 'quizzes'
	});
var author$project$PenguinMath$Intro = 0;
...
var author$project$PenguinMath$initialModel = function () {
	var emptyQuiz = {
		Z: elm$core$Array$fromList(_List_Nil),
		_: 0,
		v: '',
		ad: elm$core$Array$fromList(_List_Nil),
		T: '',
		L: 0
	};
...
var author$project$PenguinMath$AskQuestion = 1;
...
var author$project$PenguinMath$Quiz = F6(
	function (name, title, total, goal, questions, answers) {
		return {Z: answers, _: goal, v: name, ad: questions, T: title, L: total};
	});
...
var author$project$PenguinMath$fetchQuiz = F2(
	function (model, name) {
		return elm$http$Http$get(
			{
				am: A2(elm$http$Http$expectJson, author$project$PenguinMath$LoadQuiz, author$project$PenguinMath$quizDecoder),
				aH: author$project$PenguinMath$baseUrl + ('quizzes/' + name)
			});
	});
...
var author$project$PenguinMath$Enter = {$: 2};
var author$project$PenguinMath$Go = {$: 0};
var author$project$PenguinMath$Input = function (a) {
	return {$: 1, a: a};
};
var author$project$PenguinMath$Next = {$: 3};
var author$project$PenguinMath$SelectQuiz = function (a) {
	return {$: 6, a: a};
};
var author$project$PenguinMath$StartOver = {$: 4};
	...
	return A2(
		...
		function (qz) {
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$value(qz.v)
					]),
				_List_fromArray(
					[
						elm$html$Html$text(qz.T)
					]));
		},
		model.W);
};
	...
	switch (_n0) {
		...
		case 4:
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Double oops. The right answer  is ' + (model.y + '.'))
					]));
		case 5:
			return A2(
				elm$html$Html$p,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Right: ' + elm$core$String$fromInt(model.q))
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						'Wrong: ' + elm$core$String$fromInt(model.E))
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
...
var author$project$PenguinMath$main = elm$browser$Browser$element(
	{aS: author$project$PenguinMath$init, a_: author$project$PenguinMath$subscriptions, a$: author$project$PenguinMath$update, a0: author$project$PenguinMath$view});
