	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$href('https://lunamintpop.neocities.org')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$PenguinMath$main = author$project$PenguinMath$view('no model yet');
_Platform_export({'PenguinMath':{'init':_VirtualDom_init(author$project$PenguinMath$main)(0)(0)}});}(this));