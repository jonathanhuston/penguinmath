		...
		switch (msg.$) {
			...
			case 'Input':
				...
				return _Utils_update(
					...
					{myAnswer: myAnswer});
			case 'Enter':
				return author$project$PenguinMath$rightOrWrong(model);
			case 'Next':
				return author$project$PenguinMath$getNextPage(model);
			default:
				return _Utils_update(
					model,
...
var author$project$PenguinMath$main = elm$browser$Browser$sandbox(
	{init: author$project$PenguinMath$init, update: author$project$PenguinMath$update, view: author$project$PenguinMath$view});
